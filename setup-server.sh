...
read -p "Enter the Username [websrv]: " name
read -p "Enter MySQL Username [homestead]: " mysql_user
read -p "Enter MySQL Password [secret]: " mysql_pass
...
sudo mkdir -p /home/$usrname/.config/nginx
sudo chown -R $usrname:$usrname /home/$usrname
touch /home/$usrname/.config/nginx/nginx.conf
sudo ln -sf /home/$usrname/.config/nginx/nginx.conf /etc/nginx/conf.d/nginx.conf
...
sed -i "s/user www-data;/user $usrname;/" /etc/nginx/nginx.conf
sed -i "s/# server_names_hash_bucket_size.*/server_names_hash_bucket_size 64;/" /etc/nginx/nginx.conf

sed -i "s/user = www-data/user = $usrname/" /etc/php/7.3/fpm/pool.d/www.conf
sed -i "s/group = www-data/group = $usrname/" /etc/php/7.3/fpm/pool.d/www.conf

sed -i "s/listen\.owner.*/listen.owner = $usrname/" /etc/php/7.3/fpm/pool.d/www.conf
sed -i "s/listen\.group.*/listen.group = $usrname/" /etc/php/7.3/fpm/pool.d/www.conf
sed -i "s/;listen\.mode.*/listen.mode = 0666/" /etc/php/7.3/fpm/pool.d/www.conf

sed -i "s/user = www-data/user = $usrname/" /etc/php/7.2/fpm/pool.d/www.conf
sed -i "s/group = www-data/group = $usrname/" /etc/php/7.2/fpm/pool.d/www.conf

sed -i "s/listen\.owner.*/listen.owner = $usrname/" /etc/php/7.2/fpm/pool.d/www.conf
sed -i "s/listen\.group.*/listen.group = $usrname/" /etc/php/7.2/fpm/pool.d/www.conf
sed -i "s/;listen\.mode.*/listen.mode = 0666/" /etc/php/7.2/fpm/pool.d/www.conf

sed -i "s/user = www-data/user = $usrname/" /etc/php/7.1/fpm/pool.d/www.conf
sed -i "s/group = www-data/group = $usrname/" /etc/php/7.1/fpm/pool.d/www.conf

sed -i "s/listen\.owner.*/listen.owner = $usrname/" /etc/php/7.1/fpm/pool.d/www.conf
sed -i "s/listen\.group.*/listen.group = $usrname/" /etc/php/7.1/fpm/pool.d/www.conf
sed -i "s/;listen\.mode.*/listen.mode = 0666/" /etc/php/7.1/fpm/pool.d/www.conf

sed -i "s/user = www-data/user = $usrname/" /etc/php/7.0/fpm/pool.d/www.conf
sed -i "s/group = www-data/group = $usrname/" /etc/php/7.0/fpm/pool.d/www.conf

sed -i "s/listen\.owner.*/listen.owner = $usrname/" /etc/php/7.0/fpm/pool.d/www.conf
sed -i "s/listen\.group.*/listen.group = $usrname/" /etc/php/7.0/fpm/pool.d/www.conf
sed -i "s/;listen\.mode.*/listen.mode = 0666/" /etc/php/7.0/fpm/pool.d/www.conf

sed -i "s/user = www-data/user = $usrname/" /etc/php/5.6/fpm/pool.d/www.conf
sed -i "s/group = www-data/group = $usrname/" /etc/php/5.6/fpm/pool.d/www.conf

sed -i "s/listen\.owner.*/listen.owner = $usrname/" /etc/php/5.6/fpm/pool.d/www.conf
sed -i "s/listen\.group.*/listen.group = $usrname/" /etc/php/5.6/fpm/pool.d/www.conf
...
# Add $usrname User To WWW-Data
usermod -a -G www-data $usrname
id $usrname
groups $usrname
...
sudo tee /home/$usrname/.my.cnf <<EOL
[mysqld]
...
sudo -u postgres psql -c "CREATE ROLE $db_user LOGIN PASSWORD '$db_pass' SUPERUSER INHERIT NOCREATEDB NOCREATEROLE NOREPLICATION;"
sudo -u postgres /usr/bin/createdb --echo --owner=$db_user homestead
...
chown -R $usrname:$usrname /usr/local/bin

# Add Composer Global Bin To Path
printf "\nPATH=\"$(sudo su - $usrname -c 'composer config -g home 2>/dev/null')/vendor/bin:\$PATH\"\n" | tee -a /home/$usrname/.profile
